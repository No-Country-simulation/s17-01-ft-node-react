...
export default function Page() {
  const [current, setCurrent] = useState<
    "Contenido" | "Estadísticas" | "Billetera"
  >("Contenido");
  return (
        ...
        <nav className={styles.nav}>
          <ul className={styles.nav_list}>
            <li className={styles.nav_item}>
              <Selector
                onClick={() => setCurrent("Contenido")}
                current={current == "Contenido"}
              >
                <Grid2x2X size={20} />
                Contenido
              </Selector>
            ...
            <li className={styles.nav_item}>
              <Selector
                onClick={() => setCurrent("Estadísticas")}
                current={current == "Estadísticas"}
              >
                <Activity size={20} />
                Estadísticas
              </Selector>
            ...
            <li className={styles.nav_item}>
              <Selector
                onClick={() => setCurrent("Billetera")}
                current={current == "Billetera"}
              >
                <Wallet size={20} />
                Billetera
              </Selector>
