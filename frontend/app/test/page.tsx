  ...
  return (
    <section>
      ...
      <div className={styles.buttons_container}>
        <Button variant="main" disabled={disabled} onClick={handleDisabled}>
          Main Button
        </Button>
        <Button
          variant="secondary"
        ...
        <Button
          variant="tertiary"
          disabled={disabled}
          onClick={() => console.log("Secondary Icon Button")}
        >
          Tertiary
        </Button>
        <Button
        ...
        <Button
          ...
          disabled={disabled}
          onClick={() => console.log("Main Icon Button")}
        >
          <Send size={20} />
        </Button>
        <Button
          ...
          disabled={disabled}
          onClick={() => console.log("Tertiary Icon Button")}
        >
          <Send size={20} />
        </Button>
        <Button
