    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.input_container}>
                ...
                />
                {props.type == "password" && (
                    <button type="button" onClick={()=>setShowPassword(!showPassword)} className={styles.clear_button}>
            ...
            <p className={styles.error_message}>{!props.value && props.missing ? "Completá este campo" : props.errorMessage ? props.errorMessage : ""}</p>
        </div>
    );
};
